...
Overall, the calibrated DML estimator outperformed the AIPW estimator in terms of confidence interval coverage, RMSE, and absolute bias across a range of semi-synthetic datasets.% The isotonic calibration step in the calibrated DML estimator improved the accuracy of point estimates, while the bootstrap-assisted confidence intervals provided better coverage properties. 
...
\begin{table}[tb]
    ...
    \begin{subtable}{\textwidth}
        ...
        \begin{tabular}{|c||P{1.5cm}|P{1.5cm}||P{1.5cm}|P{1.5cm}||P{1.5cm}|P{1.5cm}|}
            ...
            \hline\hline
             ACIC-2017 (18) & 0.27 & \textbf{0.64} & 0.70 & \textbf{0.58} & \textbf{0.21} & 0.28 \\
            \hline
             ACIC-2017 (20) & 0.32 & \textbf{0.90} & 2.00 & \textbf{1.40} & 1.60 & \textbf{0.20} \\
            \hline
             ACIC-2017 (22) & 0.56 & \textbf{0.81} & 0.11 & \textbf{0.10} & \textbf{0.004} & 0.035 \\
            \hline
             ACIC-2017 (24) & 0.32 & \textbf{0.90} & 0.34 & \textbf{0.25} & 0.30 & \textbf{0.04} \\
            \hline
             ACIC-2018 (10000) & 0.55 & \textbf{0.68} & 690 & \textbf{680} & 17 & \textbf{13} \\
            \hline
             IHDP & \textbf{0.57} & \textbf{0.57} & \textbf{0.46} & \textbf{0.46} & \textbf{0.13} & \textbf{0.13} \\
            \hline
             Lalonde CPS & 0.16 & \textbf{0.75} & \textbf{0.22} & 0.34 & 0.14 & \textbf{0.084} \\
            \hline
             Lalonde PSID & 0.46 & \textbf{0.84} & \textbf{0.19} & 0.44 & \textbf{0.04} & \textbf{0.04} \\
            \hline
             Twins & 0.51 & \textbf{0.54} & 0.24 & \textbf{0.23} & 0.22 & \textbf{0.21} \\
            \hline
        \end{tabular}
    \end{subtable}
\end{table}
